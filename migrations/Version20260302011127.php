 ...
 */
final class Version20260302011127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD nom VARCHAR(100) NOT NULL, ADD description LONGTEXT DEFAULT NULL');
    }
