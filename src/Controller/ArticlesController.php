...
{
    // TextFormatter injecté une seule fois pour tout le contrôleur
    ...
    public function nouveau(
        ...
        // TextFormatter n'est plus ici — on utilise $this->formatter
    ): Response {
        $article = new Article();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Accès via $this->formatter grâce au constructeur
            $article->setContenu($this->formatter->filter($article->getContenu()));
